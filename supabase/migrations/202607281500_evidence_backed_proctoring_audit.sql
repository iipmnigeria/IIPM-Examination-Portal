...
begin
  ...
  -- The legacy submit function writes its preliminary score before inserting the
  -- attempt. Correct the session again at the authoritative attempt boundary.
...
-- Reconcile legacy arbitrary scores. A score without a persisted event is not evidence.
