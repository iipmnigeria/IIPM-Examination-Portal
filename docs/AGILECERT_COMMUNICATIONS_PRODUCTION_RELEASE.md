...
- administrator review of sender identity, webhook configuration and suppression handling.

Until those controls are deliberately configured, the production communications system remains deployed but fail-closed for outbound delivery.
