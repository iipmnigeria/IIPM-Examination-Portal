...
import AgileCertPublicLandingPage from './components/AgileCertPublicLandingPage';
...
export default function App() {
  ...
  if (!userRole) {
    return <AgileCertPublicLandingPage onLoginSuccess={handleLoginSuccess} />;
  }
    ...
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center gap-4 text-slate-100">
        ...
        <p className="text-sm font-bold uppercase tracking-widest text-slate-400">
          Synchronising secure certification records...
        </p>
      </div>
    );
  }
          ...
          <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-400">Powered by IIPM · Secure Certification Runtime</p>
              </div>
            </div>
