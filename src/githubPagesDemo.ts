...
const examsDatabase: Test[] = [
  ...
  },
  {
    ...
    questions: [
      {
        id: 'chrmg-q1',
        text: 'What is the most critical initial step after a formal employee grievance is filed?',
        options: [
          'Issue immediate discipline.',
          'Initiate an objective, prompt, and documented fact-finding investigation.',
          'Ask the employee to resolve it alone.',
          'Disclose the complaint to the whole department.',
        ],
        correctOptionIndex: 1,
      },
      {
        id: 'chrmg-q2',
        text: 'What does SMART stand for in goal setting?',
        options: [
      ...
      {
        id: 'chrmg-q3',
        text: 'What describes a Total Rewards strategy?',
        options: [
          'Overtime restrictions plus awards.',
          'The integration of pay, benefits, recognition, work-life support, and development opportunities.',
          'Equal pay across all roles regardless of responsibility.',
          'Lunch vouchers as the primary compensation.',
        ],
        correctOptionIndex: 1,
      },
      {
        id: 'chrmg-q4',
        text: 'Which conflict style seeks a collaborative win-win resolution?',
        options: ['Avoiding', 'Collaborating', 'Competing', 'Accommodating'],
        correctOptionIndex: 1,
      },
      {
        id: 'chrmg-q5',
        text: 'What is the primary operational goal of a Performance Improvement Plan?',
        options: [
          'Create a record for immediate dismissal.',
          'Provide a constructive documented roadmap with clear benchmarks for improvement.',
          'Reduce base pay.',
          'Move the employee automatically to consulting.',
        ],
        correctOptionIndex: 1,
      },
    ],
